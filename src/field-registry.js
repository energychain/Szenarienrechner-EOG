...
export const measureFields = [
  ...
  field({ key: 'gasTransformationEvidence', group: 'gasTransformationspfad', order: 70, label: 'Beleg Transformationspfad', type: 'text', appliesWhen: isGas, sentence: 'Beleg: {v}', evidenceKey: 'gasTransformationEvidence', clarificationOn: v => !String(v || '').trim() }),
