...
//
// optionLabels: deutsche Anzeigebeschriftung je Rohwert eines Select-Felds
// (die Rohwerte selbst bleiben englische/camelCase Enum-Konstanten, wie sie
// im Modell-JSON stehen — nur die Anzeige wird übersetzt, nicht der Wert).
// Wo bereits eine kanonische deutsche Bezeichnung existiert (Wirkannahme-
// Felder, Tragfähigkeitskategorie), wird sie importiert statt dupliziert.

import { confidenceLabels, evidenceTypeLabels, governanceLabels, impactAreaLabels } from './ui-config.js';
import { VIABILITY_CATEGORY_LABELS } from './viability-classification.js';
...
export const measureFields = [
  ...
  field({ key: 'type', group: 'identitaet', order: 40, label: 'Typ', type: 'select', options: ['wahl', 'noRegret', 'risiko'], optionLabels: { "wahl": "Wahlmaßnahme", "noRegret": "No-Regret", "risiko": "Risikomaßnahme" }, default: 'wahl', sentence: 'ist als {v} klassifiziert' }),
  ...
  field({ key: 'depr', group: 'investitionAktivierung', order: 90, label: 'Abschreibungsmodus', type: 'select', options: ['normal', 'kanuLinear', 'kanuDegressive'], optionLabels: { "normal": "Normal linear", "kanuLinear": "KANU linear", "kanuDegressive": "KANU degressiv" }, sentence: 'Abschreibung: {v}', helper: 'depreciationLifeHelper' }),
  field({ key: 'effectType', group: 'investitionAktivierung', order: 100, label: 'Wirkungstyp', type: 'select', options: ['classic', 'flexibility'], optionLabels: { "classic": "klassische CAPEX-Maßnahme", "flexibility": "Flexibilität / Netzfahrplan" }, default: 'classic', sentence: 'Wirkungstyp {v}' }),
  ...
  field({ key: 'reinvestMode', group: 'lebenszyklus', order: 40, label: 'Re-Investitionsmodus', type: 'select', options: ['oneOff', 'assetAddition'], optionLabels: { "oneOff": "vereinfachter Einmalabzug", "assetAddition": "neuer Anlagenzugang" }, default: 'oneOff', sentence: 'Re-Investition als {v}' }),
  ...
  field({ key: 'gasTransformationPath', group: 'gasTransformationspfad', order: 10, label: 'Transformationspfad', type: 'select', options: ['unclear', 'continueOperation', 'shutdownOnly', 'physicalDismantling', 'reinvestment', 'h2Option', 'tolerateInGround'], optionLabels: { "unclear": "offen / zu klären", "continueOperation": "Weiterbetrieb", "shutdownOnly": "Stilllegung ohne physischen Rückbau", "physicalDismantling": "Physischer Rückbau", "reinvestment": "Reinvestition / Erneuerung", "h2Option": "H2-/Umwidmungsoption", "tolerateInGround": "Belassen/Duldung im Boden" }, default: 'unclear', appliesWhen: isGas, sentence: 'folgt dem Transformationspfad {v}', helper: 'gasTransformationHelper', clarificationOn: v => !v || v === 'unclear' }),
  field({ key: 'gasAssetScope', group: 'gasTransformationspfad', order: 20, label: 'Asset-Geltungsbereich', type: 'select', options: ['unclear', 'distributionLine', 'connectionLine', 'station', 'h2Candidate', 'other'], optionLabels: { "unclear": "Objektart offen / zu klären", "distributionLine": "allgemeines Gasverteilnetz", "connectionLine": "Gasnetzanschlussleitung / Hausanschluss", "station": "Station / Anlage", "h2Candidate": "potenzielle Wasserstoffleitung", "other": "sonstige Gas-Anlage" }, default: 'unclear', appliesWhen: isGas, sentence: 'betrifft den Asset-Geltungsbereich {v}', helper: 'gasTransformationHelper' }),
  field({ key: 'gasObligationBasis', group: 'gasTransformationspfad', order: 30, label: 'Verpflichtungsgrundlage', type: 'select', options: ['unclear', 'legalOrContractual', 'concession', 'customerContract', 'noneKnown'], optionLabels: { "unclear": "offen / zu prüfen", "legalOrContractual": "gesetzlich oder vertraglich konkret", "concession": "Konzession / Wegenutzung", "customerContract": "Kunden-/Anschlussverhältnis", "noneKnown": "derzeit keine konkrete Pflicht bekannt" }, default: 'unclear', appliesWhen: isGas, sentence: 'stützt sich auf die Verpflichtungsgrundlage {v}', helper: 'gasTransformationHelper' }),
  field({ key: 'gasEternityAssumption', group: 'gasTransformationspfad', order: 40, label: 'Ewigkeitsvermutung', type: 'select', options: ['unclear', 'removed', 'continued'], optionLabels: { "unclear": "offen / prüfpflichtig", "removed": "Wegfall der Ewigkeitsvermutung berücksichtigen", "continued": "dauerhafter Weiterbetrieb als Arbeitshypothese" }, default: 'unclear', appliesWhen: isGas, sentence: 'Ewigkeitsvermutung: {v}', helper: 'gasTransformationHelper', clarificationOn: v => !v || v === 'unclear' }),
  field({ key: 'gasProvisionAssessment', group: 'gasTransformationspfad', order: 50, label: 'Rückstellungsprüfung', type: 'select', options: ['unclear', 'checkProvision', 'notConcrete', 'notApplicable'], optionLabels: { "unclear": "offen / zu prüfen", "checkProvision": "Rückstellung prüfen", "notConcrete": "noch nicht hinreichend konkret", "notApplicable": "nicht einschlägig" }, default: 'unclear', appliesWhen: isGas, sentence: 'Rückstellungsprüfung: {v}', helper: 'gasTransformationHelper' }),
  field({ key: 'gasRegulatoryTreatment', group: 'gasTransformationspfad', order: 60, label: 'Regulatorische Behandlung', type: 'select', options: ['unclear', 'kanuOrActualCostReview', 'costPathReview', 'h2ExceptionReview', 'notModeled'], optionLabels: { "unclear": "offen / zu prüfen", "kanuOrActualCostReview": "KAnEu-/Ist-Kosten-Behandlung prüfen", "costPathReview": "Kostenpfad / EOG-Wirkung prüfen", "h2ExceptionReview": "H2-/KANU-Ausnahme prüfen", "notModeled": "nicht modelliert" }, default: 'unclear', appliesWhen: isGas, sentence: 'regulatorisch behandelt als {v}', helper: 'gasTransformationHelper' }),
  ...
  field({ key: 'flexibilityUseCase', group: 'flexibilitaetNetzfahrplan', order: 10, label: 'Anwendungsfall', type: 'select', options: ['netzfahrplan', 'capexAvoidance', 'storage', 'controllableLoad', 'other'], optionLabels: { "netzfahrplan": "Netzfahrplan", "capexAvoidance": "vermiedene CAPEX", "storage": "Speicher / flexibles Asset", "controllableLoad": "steuerbare Last / Erzeugung", "other": "sonstiger Flexibilitätsfall" }, default: 'netzfahrplan', appliesWhen: isStrom, sentence: 'Anwendungsfall {v}', helper: 'flexibilityHelper' }),
  field({ key: 'flexibilityStatus', group: 'flexibilitaetNetzfahrplan', order: 20, label: 'Status', type: 'select', options: ['context', 'pruefpflichtig', 'quantified', 'active'], optionLabels: { "context": "Kontext, nicht rechenwirksam", "pruefpflichtig": "prüfpflichtig", "quantified": "quantifiziert, noch nicht aktiv", "active": "aktiv rechenwirksam" }, default: 'context', appliesWhen: isStrom, sentence: 'Flexibilitätsstatus {v}', helper: 'flexibilityHelper', clarificationOn: v => v === 'context' || v === 'pruefpflichtig' }),
  field({ key: 'regulatoryTreatment', group: 'flexibilitaetNetzfahrplan', order: 30, label: 'Regulatorische Behandlung', type: 'select', options: ['unknown', 'capex_avoidance', 'opex_recognition', 'mixed', 'not_applicable'], optionLabels: { "unknown": "offen / unbekannt", "capex_avoidance": "CAPEX-Vermeidung", "opex_recognition": "OPEX-Anerkennung", "mixed": "gemischt", "not_applicable": "nicht einschlägig" }, default: 'unknown', appliesWhen: isStrom, sentence: 'regulatorisch behandelt als {v}' }),
  ...
  field({ key: 'networkScheduleStatus', group: 'flexibilitaetNetzfahrplan', order: 50, label: 'Netzfahrplan-Status', type: 'select', options: ['missing', 'draft', 'validated'], optionLabels: { "missing": "fehlt", "draft": "Entwurf", "validated": "validiert" }, default: 'missing', appliesWhen: isStrom, sentence: 'Netzfahrplan-Status {v}', clarificationOn: v => v === 'missing' }),
  ...
  field({ key: 'affectedNetworkLevel', group: 'flexibilitaetNetzfahrplan', order: 70, label: 'Betroffene Netzebene', type: 'select', options: ['', 'NS', 'MS', 'UW', 'cross_level'], optionLabels: { "": "offen", "NS": "NS", "MS": "MS", "UW": "UW", "cross_level": "ebenenübergreifend" }, appliesWhen: isStrom, sentence: 'betrifft Netzebene {v}' }),
  ...
  field({ key: 'avoidedCapexConfidence', group: 'flexibilitaetNetzfahrplan', order: 110, label: 'Konfidenz vermiedenes CAPEX', type: 'select', options: ['none', 'low', 'medium', 'high'], optionLabels: { "none": "keine", "low": "niedrig", "medium": "mittel", "high": "hoch" }, default: 'none', appliesWhen: isStrom, sentence: 'Konfidenz {v}', clarificationOn: v => !v || v === 'none' }),
  ...
  field({ key: 'opexRecognitionStatus', group: 'flexibilitaetNetzfahrplan', order: 190, label: 'OPEX-Anerkennungsstatus', type: 'select', options: ['unknown', 'pruefpflichtig', 'expected', 'not_recognized'], optionLabels: { "unknown": "offen", "pruefpflichtig": "prüfpflichtig", "expected": "erwartet", "not_recognized": "nicht anerkannt" }, default: 'unknown', appliesWhen: isStrom, sentence: 'OPEX-Anerkennungsstatus {v}', clarificationOn: v => !v || v === 'unknown' }),
  ...
  field({ key: 'agnesRole', group: 'flexibilitaetNetzfahrplan', order: 220, label: 'AGNeS-Rolle', type: 'select', options: ['offen', 'Steuerung', 'Abruf', 'Prognose', 'Netzfahrplan', 'Nachweis'], optionLabels: { "offen": "offen", "Steuerung": "Steuerung", "Abruf": "Abruf", "Prognose": "Prognose", "Netzfahrplan": "Netzfahrplan", "Nachweis": "Nachweis" }, default: 'offen', appliesWhen: measure => isStrom(measure) && measure?.agnesRelevant, sentence: 'AGNeS-Rolle {v}', clarificationOn: v => !v || v === 'offen' }),
  field({ key: 'agnesIntegrationStatus', group: 'flexibilitaetNetzfahrplan', order: 230, label: 'AGNeS-Integrationsstatus', type: 'select', options: ['not_assessed', 'required', 'available', 'unavailable', 'not_applicable'], optionLabels: { "not_assessed": "nicht bewertet", "required": "erforderlich", "available": "vorhanden", "unavailable": "nicht verfügbar", "not_applicable": "nicht einschlägig" }, default: 'not_assessed', appliesWhen: measure => isStrom(measure) && measure?.agnesRelevant, sentence: 'Integrationsstatus {v}' }),
  ...
  field({ key: 'regulatoryStatus', group: 'eeg2027Netzanschluss', order: 10, label: 'Regelstand', type: 'select', options: ['current_law', 'cabinet_draft_2026_07_29', 'user_defined'], optionLabels: { "current_law": "geltender Regelstand", "cabinet_draft_2026_07_29": "Kabinettsentwurf 29.07.2026", "user_defined": "nutzerdefiniert" }, default: 'current_law', appliesWhen: isStrom, sentence: 'Regelstand {v}', clarificationOn: v => v === 'cabinet_draft_2026_07_29' }),
  ...
  field({ key: 'assumptionStatus', group: 'eeg2027Netzanschluss', order: 40, label: 'Annahmestatus', type: 'select', options: ['confirmed', 'draft', 'user_supplied', 'placeholder'], optionLabels: { "confirmed": "bestätigt", "draft": "Entwurf / prüfpflichtig", "user_supplied": "nutzerseitig überschrieben", "placeholder": "Platzhalter" }, default: 'confirmed', appliesWhen: isStrom, sentence: 'Annahmestatus {v}', clarificationOn: v => v === 'draft' || v === 'placeholder' }),
  ...
  field({ key: 'capacityLimitedTechnology', group: 'eeg2027Netzanschluss', order: 60, label: 'Betroffene Technologie', type: 'select', options: ['none', 'pv', 'wind', 'all'], optionLabels: { "none": "keine", "pv": "PV", "wind": "Wind", "all": "alle" }, default: 'none', appliesWhen: measure => isStrom(measure) && measure?.capacityLimitedGridArea, sentence: 'betroffene Technologie {v}' }),
  ...
  field({ key: 'redispatchRiskClass', group: 'eeg2027Netzanschluss', order: 100, label: 'Redispatch-Risikoklasse', type: 'select', options: ['low', 'medium', 'high'], optionLabels: { "low": "niedrig", "medium": "mittel", "high": "hoch" }, default: 'low', appliesWhen: isStrom, sentence: 'Redispatch-Risikoklasse {v}', clarificationOn: v => v === 'high' }),
  ...
  field({ key: 'voltageLevel', group: 'eeg2027Netzanschluss', order: 130, label: 'Spannungsebene', type: 'select', options: ['low_voltage', 'medium_voltage', 'high_voltage'], optionLabels: { "low_voltage": "Niederspannung", "medium_voltage": "Mittelspannung", "high_voltage": "Hochspannung" }, default: 'low_voltage', appliesWhen: isStrom, sentence: 'Spannungsebene {v}' }),
  field({ key: 'connectionRequestStatus', group: 'eeg2027Netzanschluss', order: 140, label: 'Anschlussanfragestatus', type: 'select', options: ['draft', 'submitted', 'confirmed_received', 'under_review', 'capacity_reserved', 'capacity_released', 'connection_offer', 'commissioned'], optionLabels: { "draft": "Entwurf", "submitted": "eingereicht", "confirmed_received": "Eingang bestätigt", "under_review": "in Prüfung", "capacity_reserved": "Kapazität reserviert", "capacity_released": "Kapazität freigegeben", "connection_offer": "Anschlussangebot", "commissioned": "in Betrieb" }, default: 'draft', appliesWhen: isStrom, sentence: 'Anschlussstatus {v}' }),
  field({ key: 'queueRiskClass', group: 'eeg2027Netzanschluss', order: 150, label: 'Warteschlangen-Risikoklasse', type: 'select', options: ['low', 'medium', 'high'], optionLabels: { "low": "niedrig", "medium": "mittel", "high": "hoch" }, default: 'low', appliesWhen: isStrom, sentence: 'Warteschlangen-Risikoklasse {v}' }),
  ...
  field({ key: 'connectionCostContributionMode', group: 'eeg2027Netzanschluss', order: 200, label: 'Baukostenzuschuss-Modus', type: 'select', options: ['none', 'flat', 'regional_parameter', 'user_defined'], optionLabels: { "none": "keiner", "flat": "pauschal", "regional_parameter": "regionaler Parameter", "user_defined": "nutzerdefiniert" }, default: 'none', appliesWhen: measure => isStrom(measure) && measure?.generationConnectionCostContributionEnabled, sentence: 'Modus {v}' }),

  // Monitoring / §14d
  field({ key: 'monitoringProfile', group: 'monitoring14d', order: 10, label: 'Monitoring-Profil', type: 'select', options: ['none', 'monitoring', 'qreg', 'nap14d'], optionLabels: { "none": "nicht zugeordnet", "monitoring": "Monitoring aggregierbar", "qreg": "Netzleistungsfähigkeit / Q-Reg", "nap14d": "Netzausbauplan / §14d EnWG" }, default: 'none', sentence: 'Monitoring-Profil {v}' }),
  ...
  field({ key: 'permitRequired', group: 'monitoring14d', order: 80, label: 'Genehmigung erforderlich', type: 'select', options: ['unknown', 'yes', 'no'], optionLabels: { "unknown": "unbekannt", "yes": "ja", "no": "nein" }, default: 'unknown', sentence: 'Genehmigung erforderlich: {v}', clarificationOn: v => !v || v === 'unknown' }),
  ...
  field({ key: 'investmentDecisionStatus', group: 'monitoring14d', order: 100, label: 'Investitionsentscheidung', type: 'select', options: ['unknown', 'planned', 'decided', 'deferred'], optionLabels: { "unknown": "unbekannt", "planned": "geplant", "decided": "getroffen", "deferred": "verschoben" }, default: 'unknown', sentence: 'Investitionsentscheidung {v}', clarificationOn: v => !v || v === 'unknown' }),
  ...
  field({ key: 'sourceStatus', group: 'herkunftEvidenz', order: 70, label: 'Quellenstatus', type: 'select', options: ['', 'benannt', 'source_available', 'validated', 'conflicting'], optionLabels: { "": "offen", "benannt": "benannt", "source_available": "Quelle verfügbar", "validated": "validiert", "conflicting": "widersprüchlich" }, sentence: 'Quellenstatus: {v}', clarificationOn: v => !v }),
  field({ key: 'riskEvidenceStatus', group: 'herkunftEvidenz', order: 80, label: 'Risiko-Evidenzstatus', type: 'select', options: ['', 'missing', 'benannt', 'source_available', 'validated', 'conflicting'], optionLabels: { "": "offen", "missing": "fehlt", "benannt": "benannt", "source_available": "Quelle verfügbar", "validated": "validiert", "conflicting": "widersprüchlich" }, appliesWhen: measure => Number(measure?.riskAvoided || 0) > 0, sentence: 'Risiko-Evidenzstatus {v}', clarificationOn: v => !v || v === 'missing' }),
  ...
  // Tragfähigkeit
  field({ key: 'viabilityCategory', group: 'tragfaehigkeit', order: 10, label: 'Tragfähigkeitskategorie', type: 'select', options: ['', 'regulatory_must', 'asset_preservation_must', 'transformation_must_no_regret', 'strategic_option', 'synergy_timing', 'unclassified'], optionLabels: { '': 'automatisch ableiten', ...VIABILITY_CATEGORY_LABELS }, sentence: 'Tragfähigkeitskategorie {v}', clarificationOn: v => !v || v === 'unclassified' }),
  field({ key: 'viabilityCategorySource', group: 'tragfaehigkeit', order: 20, label: 'Herkunft der Einordnung', type: 'select', options: ['', 'manual', 'derived', 'imported', 'unset'], optionLabels: { "": "automatisch", "manual": "manuell gesetzt", "derived": "abgeleitet / prüfbar", "imported": "importiert", "unset": "nicht gesetzt" }, sentence: '{v}', clarificationOn: v => !v || v === 'unset' }),
  field({ key: 'viabilityRationale', group: 'tragfaehigkeit', order: 30, label: 'Begründung', type: 'text', sentence: 'Begründung: {v}' }),
  field({ key: 'refinancingBridgeStatus', group: 'tragfaehigkeit', order: 40, label: 'Refinanzierungsbrücke', type: 'select', options: ['', 'present', 'partial', 'missing', 'not_applicable'], optionLabels: { "": "automatisch bewerten", "present": "Brücke vorhanden", "partial": "teilweise belegt", "missing": "Brücke fehlt", "not_applicable": "nicht anwendbar" }, sentence: 'Refinanzierungsbrücke: {v}', clarificationOn: v => v === 'missing' || v === 'partial' }),
...
export const impactAssumptionFields = [
  ...
  field({ key: 'area', group: 'wirkannahme', order: 10, label: 'Bereich', type: 'select', options: ['qElement', 'efficiency', 'costBase', 'risk', 'portfolio'], optionLabels: impactAreaLabels, default: 'qElement', sentence: 'Bereich {v}' }),
  ...
  field({ key: 'confidence', group: 'wirkannahme', order: 40, label: 'Vertrauensstufe', type: 'select', options: ['proven', 'assumption', 'review'], optionLabels: confidenceLabels, default: 'review', sentence: 'Vertrauensstufe {v}', clarificationOn: v => v === 'review' }),
  field({ key: 'governance', group: 'wirkannahme', order: 50, label: 'Governance', type: 'select', options: ['basis', 'sensitivity', 'excluded'], optionLabels: governanceLabels, default: 'sensitivity', sentence: 'Governance {v}', clarificationOn: v => v === 'sensitivity' }),
  ...
  field({ key: 'evidenceType', group: 'wirkannahme', order: 110, label: 'Evidenzart', type: 'select', options: ['measurement', 'operations', 'expert', 'study', 'open'], optionLabels: evidenceTypeLabels, default: 'open', sentence: 'Evidenzart {v}', clarificationOn: v => !v || v === 'open' }),
...
export const inputFields = [
  // Rahmen: Sparte
  field({ key: 'sector', group: 'rahmenSparte', order: 10, label: 'Sparte', type: 'select', options: ['gas', 'strom'], optionLabels: { "gas": "Gas", "strom": "Strom" }, default: 'gas', sentence: 'Sparte {v}' }),
  field({ key: 'regulationProcedure', group: 'rahmenSparte', order: 20, label: 'Regulierungsverfahren', type: 'select', options: ['standard', 'simplified'], optionLabels: { "standard": "Standardverfahren", "simplified": "Vereinfachtes Verfahren (§ 24 ARegV)" }, default: 'standard', sentence: 'Verfahren {v}' }),
  ...
  field({ key: 'capitalCostMode', group: 'rahmenKapitalkosten', order: 30, label: 'Kapitalkostenmodus', type: 'select', options: ['simple', 'advanced'], optionLabels: { "simple": "Einfacher Mischsatz", "advanced": "Advanced: EK/FK + Abzugskapital" }, default: 'simple', sentence: 'Kapitalkostenmodus {v}', helper: 'financingSpreadHelper' }),
  ...
  field({ key: 'conservativeAssumptionMode', group: 'szenarioKonservativ', order: 50, label: 'Annahmemodus', type: 'select', options: ['approvedOnly', 'basisNoReview', 'includeReview'], optionLabels: { "approvedOnly": "nur bestätigte Basisannahmen", "basisNoReview": "Basisannahmen ohne Review", "includeReview": "auch prüfpflichtige Annahmen" }, default: 'approvedOnly', sentence: 'Annahmemodus {v}' })
];
...
export const committeeFields = [
  ...
  field({ key: 'committeeAudience', group: 'befassung', order: 20, label: 'Adressat', type: 'select', options: ['kommunal', 'vorstand'], optionLabels: { "kommunal": "Kommunaler Befassungskreis", "vorstand": "Vorstand" }, default: 'kommunal', sentence: 'Adressat {v}' }),
...
export const sidecarObjectFields = [
  ...
  field({ key: 'type', group: 'kontext', order: 10, label: 'Typ', type: 'text', default: 'evidence_only', sentence: 'Typ {v}' }),
  field({ key: 'division', group: 'kontext', order: 20, label: 'Sparte', type: 'select', options: ['strom', 'gas', 'waerme', 'wasser', 'cross_division'], optionLabels: { "strom": "Strom", "gas": "Gas", "waerme": "Wärme", "wasser": "Wasser", "cross_division": "spartenübergreifend" }, default: 'cross_division', sentence: 'Sparte {v}' }),
  ...
  field({ key: 'status', group: 'kontext', order: 50, label: 'Status', type: 'select', options: ['context', 'pruefpflichtig', 'quantified', 'active', 'archived'], optionLabels: { "context": "Kontext", "pruefpflichtig": "prüfpflichtig", "quantified": "quantifiziert", "active": "aktiv", "archived": "archiviert" }, default: 'context', sentence: 'Status {v}' }),
  field({ key: 'sidecarType', group: 'kontext', order: 60, label: 'Kontextart', type: 'select', options: ['context', 'sensitivity', 'effect_assumption', 'economic_bridge', 'system_reference'], optionLabels: { "context": "Kontext", "sensitivity": "Sensitivität", "effect_assumption": "Wirkannahme", "economic_bridge": "wirtschaftliche Überleitung", "system_reference": "Systemreferenz" }, default: 'context', sentence: 'Kontextart {v}' }),
  field({ key: 'activationStatus', group: 'kontext', order: 70, label: 'Aktivierungsstatus', type: 'select', options: ['not_activated', 'candidate', 'ready_for_activation', 'activated', 'rejected'], optionLabels: { "not_activated": "nicht aktiviert", "candidate": "Kandidat", "ready_for_activation": "bereit zur Aktivierung", "activated": "aktiviert", "rejected": "verworfen" }, default: 'not_activated', sentence: 'Aktivierungsstatus {v}' }),
  field({ key: 'evidenceStatus', group: 'kontext', order: 80, label: 'Evidenzstatus', type: 'select', options: ['missing', 'stated', 'source_available', 'validated', 'conflicting', 'stale'], optionLabels: { "missing": "fehlt", "stated": "benannt", "source_available": "Quelle verfügbar", "validated": "validiert", "conflicting": "widersprüchlich", "stale": "veraltet" }, default: 'missing', sentence: 'Evidenzstatus {v}', evidenceKey: 'evidenceStatus', clarificationOn: v => ['missing', 'stated', 'conflicting', 'stale'].includes(v) }),
  field({ key: 'calculationImpact', group: 'kontext', order: 90, label: 'Rechenwirkung', type: 'select', options: ['none', 'scenario_only', 'indirect', 'active'], optionLabels: { "none": "keine", "scenario_only": "nur Szenario", "indirect": "indirekt", "active": "aktiv markiert" }, default: 'none', sentence: 'Rechenwirkung {v}' }),
  ...
  field({ key: 'sensitivity', group: 'kontext', order: 150, label: 'Sensitivität', type: 'select', options: ['public', 'internal', 'private', 'confidential'], optionLabels: { "public": "öffentlich", "internal": "intern", "private": "privat", "confidential": "vertraulich" }, default: 'internal', sentence: 'Sensitivität {v}' }),
  field({ key: 'exportStatus', group: 'kontext', order: 160, label: 'Exportstatus', type: 'select', options: ['allowed', 'sanitized_only', 'excluded'], optionLabels: { "allowed": "erlaubt", "sanitized_only": "nur sanitisiert", "excluded": "ausgeschlossen" }, default: 'sanitized_only', sentence: 'Exportstatus {v}' }),
...
export const sidecarBridgeLogicFields = [
  ...
  field({ key: 'economicRelation', group: 'ueberleitung', order: 20, label: 'Wirtschaftlicher Bezug', type: 'select', options: ['none', 'opex_effect', 'capex_dependency', 'revenue_effect', 'risk_effect', 'timing_effect', 'avoided_cost'], optionLabels: { "none": "keine", "opex_effect": "OPEX-Effekt", "capex_dependency": "CAPEX-Abhängigkeit", "revenue_effect": "Erlöseffekt", "risk_effect": "Risikoeffekt", "timing_effect": "Timing-Effekt", "avoided_cost": "vermiedene Kosten" }, default: 'none', sentence: 'wirtschaftlicher Bezug {v}', clarificationOn: v => !v || v === 'none' }),
  field({ key: 'direction', group: 'ueberleitung', order: 30, label: 'Richtung', type: 'select', options: ['none', 'positive', 'negative', 'mixed', 'unclear'], optionLabels: { "none": "keine", "positive": "positiv", "negative": "negativ", "mixed": "gemischt", "unclear": "unklar" }, default: 'none', sentence: 'Richtung {v}' }),
  field({ key: 'quantificationStatus', group: 'ueberleitung', order: 40, label: 'Quantifizierungsstatus', type: 'select', options: ['not_applicable', 'open', 'described', 'working_value', 'validated'], optionLabels: { "not_applicable": "nicht anwendbar", "open": "offen", "described": "beschrieben", "working_value": "Arbeitswert", "validated": "validiert" }, default: 'not_applicable', sentence: 'Quantifizierungsstatus {v}', clarificationOn: v => ['not_applicable', 'open', 'described'].includes(v) }),
...
export const sidecarSourceFields = [
  ...
  field({ key: 'sensitivity', group: 'quelle', order: 50, label: 'Sensitivität', type: 'select', options: ['public', 'internal', 'private', 'confidential'], optionLabels: { "public": "öffentlich", "internal": "intern", "private": "privat", "confidential": "vertraulich" }, default: 'internal', sentence: 'Sensitivität {v}' }),
  field({ key: 'exportStatus', group: 'quelle', order: 60, label: 'Exportstatus', type: 'select', options: ['allowed', 'sanitized_only', 'excluded'], optionLabels: { "allowed": "erlaubt", "sanitized_only": "nur sanitisiert", "excluded": "ausgeschlossen" }, default: 'sanitized_only', sentence: 'Exportstatus {v}' })
];
