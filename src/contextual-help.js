export const fieldHelp = {
  ...
  sidecarTitle: 'Kurzbezeichnung des Kontext- oder Evidenzobjekts. Nutze Kontextobjekte für Wissen, das Maßnahmen bewertet oder begründet, aber selbst keine klassische Investitionsmaßnahme ist.',
  sidecarDivision: 'Sparte des Kontextobjekts. Strom nutzt Begriffe wie Netzkoppelung, Lastanfrage, Steuerbarkeit oder Flexibilität; Gas nutzt Transformations-, Kundenpfad-, Stilllegungs- oder Umwidmungskontexte.',
  sidecarType: 'Fachliche Kategorie des Kontextwissens, zum Beispiel Datenqualität, Asset-Mapping, Lastpfad, Netzfahrplan oder externe Abhängigkeit. Die Klasse strukturiert die Prüfung, löst aber keine Rechnung aus.',
  sidecarBridgeLogic: 'Kontextobjekt sichtbar, Überleitungslogik prüfpflichtig, keine automatische KPI-Wirkung. Nutze diese Felder nur, wenn aus Kontext eine wirtschaftliche Beziehung, Sensitivität oder Wirkannahme werden könnte. Ohne freigegebene Mapping-Logik bleibt auch eine beschriebene Brücke nicht EOG-, RAB-, IRR- oder Cashflow-wirksam.',
  sidecarActivationStatus: 'Aktivierung ist ein Governance-Status, keine automatische Rechnung. Erst wenn Aktivierungsstatus, Rechenwirkung, Quantifizierung und fachlich freigegebene Mapping-Logik zusammenpassen, darf daraus später eine modellierte Wirkung werden.',
  sidecarQuantificationStatus: 'Zeigt, ob die wirtschaftliche Überleitung nur beschrieben, als Arbeitswert quantifiziert oder validiert ist. Arbeitswerte sind prüfpflichtig und sollten Quelle, Methode, Betrag, Einheit, Zeithorizont und offene Fragen tragen.',
  sidecarStatus: 'Arbeitsstatus des Kontextobjekts. Kontext und prüfpflichtig bedeuten: sichtbar für Governance und Report, aber nicht als entschiedene Maßnahme lesen.',
  ...
  sidecarCalculationImpact: 'Rechenwirkung des Kontextobjekts. None, scenario_only und indirect sind nicht KPI-wirksam; active ist nur eine Markierung und benötigt zusätzlich eine explizit implementierte Mapping-Logik, bevor Werte in EOG, RAB, CAPEX, OPEX oder Cashflow eingehen.',
