...
export const detailIds = [
  ...
  'mAgnesRelevant', 'mAgnesRole', 'mAgnesIntegrationStatus', 'mAgnesDataNeeded',
  'mRegulatoryStatus', 'mAssumptionStatus', 'mCapacityLimitedGridArea', 'mCapacityLimitedTechnology',
  'mRedispatchCompensationWaiverEnabled', 'mRedispatchCompensationWaiverLimitPct', 'mWindPriorityArea',
  'mRedispatchRiskClass', 'mAnnualRevenueAtRiskTeur', 'mConnectionRequestPowerKw', 'mVoltageLevel',
  'mConnectionRequestStatus', 'mQueueRiskClass', 'mReservationExpiryDate', 'mNextRequiredEvidence',
  'mGenerationConnectionCostContributionEnabled', 'mConnectionCostContributionTeur', 'mConnectionCostContributionMode',
  'mCost', 'mYear', 'mSecure', 'mUncertain',
  ...
  'mBridgeNumberType', 'mBridgeBudgetProcessStatus', 'mBridgeBudgetYear', 'mBridgeBudgetBucket',
  'mBridgeBudgetOwner', 'mBridgeCapexOpexTreatment', 'mBridgeActivationStatus', 'mBridgeRegulatoryEffect',
  'mBridgeReturnTiming', 'mBridgeOperationalCriticality', 'mBridgeDeferrability', 'mBridgeStatus',
  'mBridgeOwnerRole', 'mBridgeOpenQuestions',
