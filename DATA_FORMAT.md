...
- Monitoring-/Reporting-Profile nutzen `externalId` als fachlichen Schlüssel aus dem führenden System (z.B. ERP-PSP, Projektnummer, Asset-Management-ID). Interne App-IDs bleiben technische Referenzen und werden nicht als Behörden-/Monitoring-ID verwendet.
